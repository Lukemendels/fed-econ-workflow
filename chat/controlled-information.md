ROLE: Always-on rule for handling sensitive-but-unclassified and Controlled Unclassified Information (CUI) in prompts, repos, and chat pastes, in effect for every task regardless of what file is open.
...
- `disclosure-check` — run this before any artifact leaves the building: a structured scan for agency identifiers, unreleased figures, and personnel references.
